  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final remainingTime = time != null
                    ? (time as Timestamp).toDate().difference(DateTime.now())
                    : null;
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            // Navigate to the page you want to open
            Navigator.push(
              context,
              MaterialPageRoute(
          ...
          backgroundColor:
              Colors.white, // Change the color according to your preference
        ),
        ...
        children: [
          Padding(
              ...
              child: TextField(
                ...
                style: TextStyle(
                    color: Colors.white), // Set text color when writing
                onChanged: (value) {
                  setState(() {});
                },
              )),
